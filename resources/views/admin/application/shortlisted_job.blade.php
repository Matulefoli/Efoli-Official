...
<table class="table">
        ...
        <tbody>
            ...
            @php  
                ...
                $applicant=App\Applicant::find($shortlist->applicant_id);
            ...
            <tr  >
                ...
                <td colspan="5">
                    ...
                    @if($attn)
                        @foreach($attn as $attn)
                            ...
                            <i>Time Taken: 
                                @php
                                    $time=$attn->submission_time - $attn->start_time;
                                    $time=$time/1000;
                                @endphp 
                                {{$time}}s
                            </i>
                ...
                <td>
                    ...
                    <a href="{{url('admin/add_short_list/'.$applicant->id.'/'.$job_id)}}" class="btn btn-sm btn-warning float-left">UnList</a>
                    
                    <a href="{{url('admin/see_answer_script/'.$applicant->id.'/'.$job_id)}}" class="btn btn-sm btn-info float-left">See Paper</a>
                </td>
            </tr>
            @endif
